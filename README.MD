...
- [chrstphd](https://github.com/chrstphd)
- [alchemydc](https://github.com/alchemydc)
...
## Deployment
Default project URL: https://talon42.github.io/simchecklists/
...
- Boeing 737-800
- Boeing 747-800
- Bombardier Challenger CL650 (HotStart)
- Cessna 152
- Cessna 152 (ZL Sim/X-Plane)
...
- Let 410 TurboProp
- Pilatus PC-12 45/47 (Simworks)
- Piper Comanche 250 (A2A)
...
These may be older versions when compared to the web version. **Use at your own risk.**
...
### Version History: 
Version 2.3.6 (2026/11/18)
- Added Pilatus Pilatus PC-12 45/47 (Simworks) checklist by alchemydc.
- Fixed masterlist_gen.py to generate the lists in alphabetical order. (patch by alchemydc)

Version 2.3.5 (2025/11/10)
- Added Bombardier Challenger CL650 (HotStart) checklist by chrstphd
- Fixed typos and errors on the A330 / Beluga checklist.
- Fixed issue #33 - added the correct behaviour to checks.js.
- Fixed issue #34 - changed split behaviour on upload.js.

Version 2.3.4 (2025/11/07)
- Added Cessna 152 (ZL Sim/X-Plane) checklist by tibonev.
- Updated Cessna 152 checklist (fixed typos and repeated lines).
- Fixed bug with scratchpad font color in dark mode.
- Fixed bug with inner window close button color.
- Fixed bug with chrono window colors in desktop mode.
- Fixed border rendering on chrono_window.
- Changed writer pad font size to be more readable.
- About native versions: Still unsupported, they won't be updated for a while, feel free to build your own from the sources.
